...
Public Class Form1
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Select Case factClick
            ...
            Case 4
                factClick = 4
                ListBox1.Items.Add("Compattible with binary, decimal, & hexadecimal")
            ...
            Case 7
                factClick = 7
                ListBox1.Items.Add("Microprocessors were integrated circruit and magnetic tapes")
            'Case 8 adds the similiraties and differences fact when clicked on eight times. 
            Case 8
                factClick = 8
                ListBox1.Items.Add("Likewise other computers, this was one of the first mainframes")
            'Case 9 adds the first programmer fact when clicked on for a ninth time
            Case 9
                factClick = 9
                ListBox1.Items.Add("Herman Hollerith made an electro punchcard for summing info")
            'Case 10 talks about the first coder
            Case 10
                factClick = 10
                ListBox1.Items.Add("The first coder was Ava Lovelace")
           'Case 11 checks to see if you added all the facts, it shows a message box, then hides the button for no more facts to be added
            Case 11
                factClick = 11
                MessageBox.Show("You've already added all the facts!")
                Button1.Hide()
        End Select
    End Sub
